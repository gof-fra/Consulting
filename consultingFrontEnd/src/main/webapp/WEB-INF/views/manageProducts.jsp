			...
			<div class="modal-content">
				...
				<sf:form modelAttribute="category" action="${contextRoot}/manage/category"
					...
					<div class="form-group">	
						...
						<div class="col-md-8">
							<sf:input type="text" path="name" id="category_name" class="form-control" /> <!-- Category --name -->
						</div>					
					</div>
					...
					<div class="form-group">	
						...
						<div class="col-md-8">
							<sf:textarea cols="" rows="5" path="description" id="category_description" class="form-control" /> <!-- Category --description -->
						</div>					
					</div>
